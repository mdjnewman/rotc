...
helm package ../03-k8s-deploy/03-04-helm/demo/dockercoins
...
# Setup Prometheus/Stackdriver integration
./scripts/prometheus/gke/prometheus-stackdriver.sh deployment prometheus-deployment