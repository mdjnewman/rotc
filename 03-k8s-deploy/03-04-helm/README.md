...
```console
# Windows only
$env:POD_NAME=$(kubectl get pods --namespace ... -l "app=metabase,release=v1-metabase" -o jsonpath="{.items[0].metadata.name}")
echo "Visit http://127.0.0.1:8080 to use your application"
kubectl port-forward --namespace $env:NAMESPACE $env:POD_NAME 8080:3000
